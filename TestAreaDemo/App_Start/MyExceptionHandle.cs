...
namespace TestAreaDemo
{
    ...
    /// </summary>
    public class MyExceptionHandleFilter : HandleErrorAttribute
    {
        /// <summary>
        /// 在发生异常时调用
        /// </summary>
            ...
            try
            {
                ...
                if (!filterContext.HttpContext.Request.IsAjaxRequest())
                {
                    ...
                    if (!filterContext.ExceptionHandled)
                    {
                        ...
                        ViewDataDict.Add("ExpMessage", Common.GetExceptionMsg(ExceptionErr));
                ...
                WriteLogHelper.WriteLogByLog4Net(ExceptionErr, EnumType.Log4NetMsgType.Error);
            }
            catch (Exception ex)
            {
                WriteLogHelper.WriteLogByLog4Net(ex, EnumType.Log4NetMsgType.Fatal);
