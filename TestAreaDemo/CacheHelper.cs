...
namespace TestAreaDemo
{
    public class CacheHelper : GetKeyPerpoty
    {
        ...
        /// <param name="logPath"></param>
        /// <returns></returns>
        public static object Get_SetApplicationRole(WebDbContext AppdbContext = null, string logPath = "", string CacheName = "ApplicationRole")
        {
            //缓存菜单
        ...
        /// <param name="logPath"></param>
        /// <returns></returns>
        public static object Get_SetApplicationUser(WebDbContext AppdbContext = null, string logPath = "", string CacheName = "ApplicationUser")
        {
            //缓存菜单
