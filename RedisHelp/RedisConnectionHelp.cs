...
namespace RedisHelp
{
    ...
    public static class RedisConnectionHelp
    {
        ...
        public static ConnectionMultiplexer GetManager(string connectionString = null)
        {
            ...
            string RedisConnectionJson = System.Configuration.ConfigurationManager.AppSettings["RedisConnection"] ?? "";
            ...
            string RedisConnectionStr = string.IsNullOrEmpty(RedisConnectionJson) ? RedisConnectionString : "";
